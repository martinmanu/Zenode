...
import { Config, Connection as ConnectionConfig, ContextPadConfig as CPConfig } from "@zenode/core";
import { Connection as ConnectionInstance, PlacedNode, Node as NodeInstance } from "./model/interface.js";
import { VisualState, ContextPadAction, ContextPadTarget, NodeContent, NodeConfig, NodeData, EdgeConfig, EdgeData } from "@zenode/core";
...
export function registerShape(name: string, renderer: any): void { if (engineInstance) engineInstance.registerShape(name, renderer); }
...
const Zenode = {
  ...
  clear, validate, registerContextPadAction, registerShape, registerSmartConnect, copySelection, pasteSelection,
