...
import { ContextPadAction, ContextPadTarget, ShapeRenderer, BoundingBox, VisualState, NodeConfig, NodeData, EdgeConfig, EdgeData } from "@zenode/core";
...
export class ZenodeEngine {
   ...
   */
  public getDiagramState(): import("@zenode/core").ZenodeDiagramState {
   ...
   */
  updateNodeContent(id: string, content: import("@zenode/core").NodeContent, recordHistory: boolean = true): void {
    const node = this.placedNodes.find(n => n.id === id);
    if (!node) return;
