...
import type { BorderRadius, Shape } from "./configurationModel.js";
...
/**
 * Pure representation of the entire Zenode canvas state.
 * Fully decoupled from engine mechanics.
 */
export interface ZenodeDiagramState {
  version: "1.0";
  nodes: NodeData[];
  edges: EdgeData[];
  viewport: {
